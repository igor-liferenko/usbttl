...
# 129 "./LUFA/Drivers/Board/AVR8/USBKEY/LEDs.h"
   ...
   static inline uint8_t LEDs_GetLEDs(void) __attribute__ ((warn_unused_result));
...
# 180 "./LUFA/Drivers/Peripheral/AVR8/Serial_AVR8.h"
          = (DoubleSpeed ? ((((16000000UL / 8) + (BaudRate / 2)) / (BaudRate)) - 1) : ((((16000000UL / 16) + (BaudRate / 2)) / (BaudRate)) - 1));
...
# 208 "./LUFA/Drivers/Peripheral/AVR8/Serial_AVR8.h"
                     Serial_IsCharReceived(void) __attribute__ ((warn_unused_result)) __attribute__ ((always_inline));
   static inline 
...
# 219 "./LUFA/Drivers/Peripheral/AVR8/Serial_AVR8.h"
                     Serial_IsSendReady(void) __attribute__ ((warn_unused_result)) __attribute__ ((always_inline));
   static inline 
...
# 230 "./LUFA/Drivers/Peripheral/AVR8/Serial_AVR8.h"
                     Serial_IsSendComplete(void) __attribute__ ((warn_unused_result)) __attribute__ ((always_inline));
   static inline 
...
# 243 "./LUFA/Drivers/Peripheral/AVR8/Serial_AVR8.h"
   static inline void Serial_SendByte(const char DataByte) __attribute__ ((always_inline));
...
# 129 "./LUFA/Drivers/Misc/RingBuffer.h"
  static inline void RingBuffer_InitBuffer(RingBuffer_t* Buffer,
                                           ...
                                           const uint16_t Size) __attribute__ ((nonnull (1))) __attribute__ ((nonnull (2)));
  static inline void RingBuffer_InitBuffer(RingBuffer_t* Buffer,
                                           uint8_t* const DataPtr,
                                           const uint16_t Size)
  {
...
# 165 "./LUFA/Drivers/Misc/RingBuffer.h"
  static inline uint16_t RingBuffer_GetCount(RingBuffer_t* const Buffer) __attribute__ ((warn_unused_result)) __attribute__ ((nonnull (1)));
...
# 191 "./LUFA/Drivers/Misc/RingBuffer.h"
  static inline uint16_t RingBuffer_GetFreeCount(RingBuffer_t* const Buffer) __attribute__ ((warn_unused_result)) __attribute__ ((nonnull (1)));
...
# 209 "./LUFA/Drivers/Misc/RingBuffer.h" 3 4
               _Bool 
# 209 "./LUFA/Drivers/Misc/RingBuffer.h"
                    RingBuffer_IsEmpty(RingBuffer_t* const Buffer) __attribute__ ((warn_unused_result)) __attribute__ ((nonnull (1)));
  static inline 
...
# 223 "./LUFA/Drivers/Misc/RingBuffer.h" 3 4
               _Bool 
# 223 "./LUFA/Drivers/Misc/RingBuffer.h"
                    RingBuffer_IsFull(RingBuffer_t* const Buffer) __attribute__ ((warn_unused_result)) __attribute__ ((nonnull (1)));
  static inline 
...
# 268 "./LUFA/Drivers/Misc/RingBuffer.h"
  static inline uint8_t RingBuffer_Remove(RingBuffer_t* Buffer) __attribute__ ((nonnull (1)));
...
static int CDC_Device_putchar(char c,FILE*Stream)__attribute__ ((nonnull (2)));
...
void EVENT_CDC_Device_BreakSent(USB_ClassInfo_CDC_Device_t*const CDCInterfaceInfo,
const uint8_t Duration)__attribute__ ((weak)) __attribute__ ((nonnull (1)))__attribute__ ((alias( "CDC_Device_Event_Stub" )));
# 2001 "usb.w"
...
# 1048 "usb.w"
                                     LanguageString=
{ .Header = {.Size = sizeof(USB_Descriptor_Header_t) + sizeof((uint16_t){0x0409}), .Type = DTYPE_String}, .UnicodeString = {0x0409} };
# 1057 "usb.w"
...
# 1058 "usb.w"
                                     ManufacturerString=
{ .Header = {.Size = sizeof(USB_Descriptor_Header_t) + (sizeof(L"Dean Camera") - 2), .Type = DTYPE_String}, .UnicodeString = L"Dean Camera" };
# 1067 "usb.w"
...
# 1068 "usb.w"
                                     ProductString=
{ .Header = {.Size = sizeof(USB_Descriptor_Header_t) + (sizeof(L"LUFA USB-RS232 Adapter") - 2), .Type = DTYPE_String}, .UnicodeString = L"LUFA USB-RS232 Adapter" };
# 1155 "usb.w"
...
uint8_t BytesToSend= (((BufferCount) < ((16 -1))) ? (BufferCount) : ((16 -1)));
# 285 "usb.w"
# 297 "usb.w"
...
RingBuffer_Peek(&USARTtoUSB_Buffer))!=0)break;
# 300 "usb.w"
# 313 "usb.w"
...
LEDs_SetAllLEDs(ConfigSuccess?((1 << 5)|(1 << 6)):((1 << 4)|(1 << 7)));
}
# 509 "usb.w"
...
else if(((USB_Descriptor_Header_t*)(*CurrConfigLoc))->Type==BeforeType)
{
*BytesRem= 0;
return;
}
...
(*(volatile uint8_t *)((0x1E) + 0x20))
# 2102 "usb.w"
              = (USB_Device_IsAddressSet())?DEVICE_STATE_Configured:DEVICE_STATE_Powered;
...
SignatureDescriptor.Header.Size= (sizeof(USB_Descriptor_Header_t) + ((80/4) << 1));
...
uint8_t EndpointIndex= ((uint8_t)USB_ControlRequest.wIndex&0x0F);
